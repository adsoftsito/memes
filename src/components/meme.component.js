...
export default class Tutorial extends Component {
  ...
  updatePublished(status) {
    MemeDataService.update(this.state.currentTutorial.id, {
      published: status,
    })
      .then(() => {
        this.setState((prevState) => ({
  ...
  updateTutorial() {
    ...
    MemeDataService.update(this.state.currentTutorial.id, data)
      .then(() => {
        this.setState({
  ...
  deleteTutorial() {
     MemeDataService.delete(this.state.currentTutorial.id)
      .then(() => {
